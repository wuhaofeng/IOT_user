package com.iot.user.ui.view.mine;
...
public class MySettingItemView extends FrameLayout {
    ...
    public MySettingItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            switch (index) {
                case R.styleable.SettingView_setting_image:
                    imageSrcId = typedArray.getResourceId(R.styleable.SettingView_setting_image,0);
                    break;
    ...
    private void initView() {
        ...
        iv_setting_left = findViewById(R.id.setting_left_iv);
        ...
        if(imageSrcId!=0){
            iv_setting_left.setImageResource(imageSrcId);
        }
    }
