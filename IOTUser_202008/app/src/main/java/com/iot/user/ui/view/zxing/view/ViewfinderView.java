...
package com.iot.user.ui.view.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            //画扫描框边上的角，总共8个部分
            paint.setColor(Color.parseColor("#80c469"));
            ...
            if (currentPossible.isEmpty()) {
                ...
                for (int i=0;i<currentPossible.size();i++){
                    ResultPoint point=(ResultPoint)currentPossible.toArray()[i];
