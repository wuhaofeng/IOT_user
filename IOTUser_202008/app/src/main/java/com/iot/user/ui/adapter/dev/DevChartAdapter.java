...
public class DevChartAdapter extends RecyclerView.Adapter<DevChartAdapter.MyViewHolder> {
    private Context context;
    private List<DevChartModel> mDatas;
    private LayoutInflater layoutInflater;
    public DevChartAdapter(Context context, List<DevChartModel> mDatas) {
    ...
    public void onBindViewHolder(final MyViewHolder viewHolder,final int position) {
        final DevChartModel devChargeItem = mDatas.get(position);
    ...
    public void updateDataWith(List<DevChartModel>mDatas){
        this.mDatas=mDatas;
