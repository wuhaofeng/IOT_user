...
public class AddressPicker extends Dialog implements View.OnClickListener {
    ...
    private boolean isOpenDistrict = true;//是否开启地区的标记
        ...
        switch (tabIndex) {
            ...
            case TAB_INDEX_CITY: //城市
                if (isOpenDistrict==true) {
                    ...
                    listener.onEnsure(-1, mAddressProvinceText.getText().toString(), mAddressCityText.getText().toString()," ", " ");
                    hide();
                }
                break;
            case TAB_INDEX_DISTRICT: //区
                if (isOpenStreet==true) {//如果开启了街道显示
    ...
    public void districtSuccess(ArrayList<String> list) {
        ...
        if (list != null) {
            if (districtList.size()==0){
                ...
                doItemClick(TAB_INDEX_CITY, mAddressDistrictText, -1, "");
                return;
            }
    ...
    public void streetSuccess(ArrayList<String> list) {
        ...
        if (list != null) {
            if (streetList.size()==0){
                isOpenStreet=false;
                doItemClick(TAB_INDEX_DISTRICT, mAddressDistrictText, -1, "");
                return;
            }
            streetAdapter = null;
